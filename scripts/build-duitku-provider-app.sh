...
(
  ...
  COPYFILE_DISABLE=1 zip -X -q "${bundle_tmp}/duitku-provider-app-emisell-v1.0.0.zip" \
...
install -m 0644 "${bundle_tmp}/duitku-provider-app-emisell-v1.0.0.zip" "${output_dir}/duitku-provider-app-emisell-v1.0.0.zip"
shasum -a 256 "${output_dir}/duitku-provider-app-emisell-v1.0.0.zip"
