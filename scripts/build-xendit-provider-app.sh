...
(
  ...
  COPYFILE_DISABLE=1 zip -X -q "${bundle_tmp}/xendit-provider-app-emisell-v2.0.2.zip" \
...
install -m 0644 "${bundle_tmp}/xendit-provider-app-emisell-v2.0.2.zip" "${output_dir}/xendit-provider-app-emisell-v2.0.2.zip"
shasum -a 256 "${output_dir}/xendit-provider-app-emisell-v2.0.2.zip"
