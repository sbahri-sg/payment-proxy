...
(
  ...
  COPYFILE_DISABLE=1 zip -X -q "${bundle_tmp}/doku-provider-app-emisell-v2.0.2.zip" \
...
install -m 0644 "${bundle_tmp}/doku-provider-app-emisell-v2.0.2.zip" "${output_dir}/doku-provider-app-emisell-v2.0.2.zip"
shasum -a 256 "${output_dir}/doku-provider-app-emisell-v2.0.2.zip"
