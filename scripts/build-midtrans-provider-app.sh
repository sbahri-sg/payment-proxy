...
(
  ...
  COPYFILE_DISABLE=1 zip -X -q "${bundle_tmp}/midtrans-provider-app-emisell-v2.0.1.zip" \
...
install -m 0644 "${bundle_tmp}/midtrans-provider-app-emisell-v2.0.1.zip" "${output_dir}/midtrans-provider-app-emisell-v2.0.1.zip"
shasum -a 256 "${output_dir}/midtrans-provider-app-emisell-v2.0.1.zip"
